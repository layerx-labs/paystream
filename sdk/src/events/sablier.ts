...
export interface CreateCompoundingStreamEvent {
  returnValues: {
    streamId: number;
    exchangeRate: number;
...
export interface CreateStreamEvent {
  returnValues: {
    streamId: number;
    sender: string;
    recipient: string;
...
export interface PayInterestEvent {
  returnValues: {
    streamId: number;
    senderInterest: number;
    recipientInterest: number;
    sablierInterest: number;
  };
}
export interface TakeEarningsEvent {
  returnValues: { tokenAddress: string; amount: number };
}
export interface UnpausedEvent {
  returnValues: { account: string };
}
export interface UpdateFeeEvent {
  returnValues: { fee: number };
}
